"""
Unet model as implemented in Denoising Diffusion Implicit Models, with minor changes.
...
class ResnetBlock(nn.Module):
    def __init__(self, *, in_channels, out_channels, conv_shortcut=False, dropout, temb_channels=512):
        super().__init__()
...
class Model(nn.Module):
    def __init__(
        ...
        # timestep embedding
        self.time_embedding = TimeEmbedding(self.ch)
